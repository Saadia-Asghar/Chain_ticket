...
function Navbar() {
    ...
    const handleConnect = ()=>{
        ...
        if (connectors.length > 0) {
            ...
            connect({
                connector: metaMask || injected || connectors[0]
            }, {
                onError: (err)=>{
            ...
            alert("No wallet connectors found. Please install a wallet like MetaMask.");
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2842afa5._.js.map